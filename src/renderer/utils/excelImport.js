...
const FIELD_ALIASES = {
  ...
  department: ['department', 'dept', 'category', 'type', 'section'],
  group:      ['group', 'group_path', 'group path', 'subgroup', 'sub group', 'sub-group', 'item group'],
...
const CASE_FIELD_ALIASES = {
  ...
  barcode:             ['barcode', 'bar code', 'upc', 'ean', 'scan code', 'scancode', 'qr code', 'qr'],
  serial:              ['serial', 'serial number', 'sn', 'serial #'],
  group:               ['group', 'group_path', 'group path', 'case group', 'subgroup', 'sub group', 'sub-group', 'category', 'section'],
